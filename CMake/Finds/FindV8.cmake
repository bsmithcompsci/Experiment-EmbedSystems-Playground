...
set(V8_BUILD_TYPE Release) # A variable to easily change the build type back and forth from debug and release.
...
if(WIN32)
	...
	# message(STATUS "${THIRDPARTY_DIR}/JS-V8/packages/v8-v${MSVC_TOOLSET_VERSION}-${ARCH}.*")
	set(V8_VERSION v8-v${MSVC_TOOLSET_VERSION}-${ARCH})
	file(GLOB V8_NUGET_DEV_DIR
		LIST_DIRECTORIES TRUE
		${THIRDPARTY_DIR}/JS-V8/packages/${V8_VERSION}.*
	)
	message(STATUS "Loaded Javascript (V8): ${V8_VERSION}")
	string(REPLACE "v8-" "v8.redist-" V8_NUGET_BIN_DIR ${V8_NUGET_DEV_DIR})

	set(V8_NUGET_INCLUDE_DIR ${V8_NUGET_DEV_DIR}/include)
	set(V8_NUGET_LIB_DIR ${V8_NUGET_DEV_DIR}/lib/${V8_BUILD_TYPE})
	set(V8_NUGET_BIN_DIR ${V8_NUGET_BIN_DIR}/lib/${V8_BUILD_TYPE})
	...
	# message(STATUS "Copy ${V8_BINARIES} to the project output dir ${BUILD_DIR}/Bin")
	file(COPY ${V8_BINARIES} DESTINATION ${BUILD_DIR}/Bin)
else()
endif()
